...
@section('title', 'Add Eblast Campaign')
@section('style')
    ...
    <div class="row breadcrumbs-top">
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo url('/admin/eblast'); ?>">Eblast Campaign</a>
          </li>
...
<div class="content-body">
  <div class="row" id="banner-detail-row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="horz-layout-icons">Eblast Campaign</h4>
    ...
    <div class="card-content collpase show administrator-page">
      <div class="card-body">
        <div class="card-text">
        </div>
        ...
        @endif
        <form id="addEblastForm" enctype="multipart/form-data" class="form form-horizontal"  accept-charset="UTF-8" role="form" method="POST" action="<?php echo url('/admin/eblast/create'); ?>">
          {{ csrf_field() }}
...
<script>
var formData = '[{"type":"text","required":true,"label":"Name","className":"form-control","name":"name","subtype":"text","maxlength":"250"},{"type":"text","subtype":"email","required":true,"label":"Email","className":"form-control","name":"email","maxlength":"250"},{"type":"text","required":true,"label":"Phone Number","className":"form-control","name":"phone","subtype":"text","maxlength":"10"}]';
  ...
  $("#addEblastForm").validate({
    ...
    messages: {
      ...
      tag_name: {
        ...
        number: 'Please enter valid tag ID (number)'
      }
    },
